...
3. 日记功能：默认每次录音识别后，识别结果记录在 `data/user/年份/月份/日期.md` ，录音文件保存在 `data/user/年份/月份/assets`
4. 关键词日记：识别结果若以关键词开头，会被记录在 `data/user/年份/月份/关键词-日期.md`，关键词在 `keywords.txt` 中定义
